...
public class BookManagement {
    ...
    private static void checkout() {
        if (shoppingCart.isEmpty()) {
            System.out.println("Giỏ hàng rỗng. Không thể thanh toán.");
        } else {
            System.out.println("******************GIỎ-HÀNG******************");
            for (Product product : shoppingCart) {
                System.out.println(product);
            ...
            System.out.println("*********************************************");
            System.out.println("Tổng số lượng sản phẩm: " + shoppingCart.size());
            System.out.println("Tổng tiền thanh toán: " + calculateTotalPrice() + " đồng");
